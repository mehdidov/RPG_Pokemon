...
def lancer_combat(pokemon_joueur, pokemon_sauvage, choix_libre=False):
    ...
    while pokemon_joueur.est_vivant() and pokemon_sauvage.est_vivant():
        ...
        if choix_libre:
            print("0. Annuler / Revenir au menu principal")

        choix = input("-> ").strip()

        # Option annuler
        if choix_libre and choix == "0":
            print("\nTu reprends le contrôle du combat.")
            return "annule"
